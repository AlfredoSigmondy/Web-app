...
<head>
  ...
  /* Green background and white text when active or hovered */
...
<body>
  <div class="d-flex flex-column flex-shrink-0 p-3 sidebar-custom">
    <a href="../patient/Dashboard.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-decoration-none">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="Consultation.php" class="nav-link <?php echo ($currentPage == 'Consultation.php') ? 'active' : 'link-dark'; ?>">Consultation</a>
      </li>
      <li>
        <a href="Doctor.php" class="nav-link <?php echo ($currentPage == 'Doctor.php') ? 'active' : 'link-dark'; ?>">Doctors</a>
      </li>
      <li>
      ...
      <li>
        <a href="MedMarket.php" class="nav-link <?php echo ($currentPage == 'MedMarket.php') ? 'active' : 'link-dark'; ?>">MedMarket</a>
      </li>
      <li>
    ...
    <ul class="nav flex-column mb-2">
      ...
      <li>
        <a href="../Homepage.php" class="nav-link <?php echo ($currentPage == 'Homepage.php') ? 'active' : 'link-dark'; ?>">Sign Out</a>
      </li>
    </ul>
    <div class="mt-auto">
